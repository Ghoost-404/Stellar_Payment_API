              ...
              className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold text-left transition-all duration-200 ${
                activeTab === item.id
                  ? item.danger
                    ...
                    : "bg-[var(--pluto-500)] text-white shadow-md"
                  : item.danger
                    ? "text-red-500 hover:bg-red-50 hover:shadow-sm"
                    : "text-[#6B6B6B] hover:bg-[var(--pluto-50)] hover:text-[var(--pluto-700)] hover:shadow-sm"
              }`}
            >
                  ...
                  <div className="rounded-xl border border-yellow-200 bg-yellow-50 p-5 flex flex-col gap-3">
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        disabled={rotating}
                        className="flex-1 rounded-xl bg-[var(--pluto-500)] py-2.5 text-xs font-bold uppercase tracking-widest text-white hover:bg-[var(--pluto-600)] disabled:opacity-50 transition-all"
                      >
                        Confirm
                      </button>
                      <button
            ...
            <div className="rounded-2xl border border-[#E8E8E8] bg-white p-8 flex flex-col gap-8">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 rounded-xl bg-[var(--pluto-500)] py-3 text-[10px] font-bold uppercase tracking-widest text-white hover:bg-[var(--pluto-600)] disabled:opacity-50 transition-all"
                >
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 rounded-xl bg-[var(--pluto-500)] py-2.5 text-[10px] font-bold uppercase tracking-widest text-white hover:bg-[var(--pluto-600)] disabled:opacity-50 transition-all"
                  >
